...
const DEFAULT_HERO = {
  badge: 'New: Zero-Config Deployment',
  title: 'Ship faster with',
  titleHighlight: 'minimal tech solutions',
  description:
    'Clean, efficient tools for developers who value simplicity. No bloat, no complexity—just what you need to build and deploy.',
  features: [
  ...
  imageAlt: 'Clean dashboard interface',
  statsLabel1: 'Build Time',
  statsValue1: '< 30s avg',
  statsLabel2: 'Uptime',
  statsValue2: '99.9% SLA',
} as const;
