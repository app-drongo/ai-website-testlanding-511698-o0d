...
export default function Footer({
  ...
  companyDescription = 'Empowering businesses with cutting-edge landing page solutions. Create high-converting pages that drive results and grow your business with our proven platform.',
  contactEmail = 'hello@testlanding.com',
  contactPhone = '+1 (555) 123-4567',
  contactAddress = '123 Innovation Drive, Suite 200, San Francisco, CA 94105',
  newsletterTitle = 'Stay Ahead of the Curve',
  newsletterDisclaimer = 'Get exclusive insights, tips, and updates delivered to your inbox. Unsubscribe anytime.',
